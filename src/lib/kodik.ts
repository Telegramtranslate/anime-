...
const SHIKI_EXTRA = [
  "Идолы", "Детское", "Взрослый каст", "Работа", "Мифология", "Путешествия во времени",
  "Гонки", "Командный спорт", "Шоу-бизнес", "Авангард", "Дзёсэй", "Мелодрама", "Криминал", "Семейный",
];
...
export const GENRES = [
  "Экшен", "Приключения", "Комедия", "Драма", "Романтика", "Удостоено наград", "Гурман", "Фэнтези", "Фантастика", "Повседневность",
  "Сверхъестественное", "Психологическое", "Триллер", "Детектив", "Школа", "Спорт", "Музыка", "Меха",
  "Исторический", "Военное", "Сёнен", "Сёдзё", "Сэйнэн", "Ужасы", "Самураи", "Боевые искусства",
  "Гарем", "Вампиры", "Демоны", "Космос", "Суперсила", "Полиция", "Пародия",
];
